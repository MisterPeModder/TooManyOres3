...
public class TmoArmorMaterial {
	...
	public static final TmoArmorMaterial TITANIUM = new TmoArmorMaterial(EnumHelper.addArmorMaterial("TITANIUM", TMORefs.PREFIX+"titanium", 33, new int[]{3, 6, 8, 3}, 10, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 2.0F), ConfigValues.BoolValues.TITANIUM_ARMOR);
	public static final TmoArmorMaterial TITANIUM_DARK = new TmoArmorMaterial(EnumHelper.addArmorMaterial("TITANIUM_DARK", TMORefs.PREFIX+"dark_titanium", 34, new int[]{3, 6, 8, 3}, 10, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 2.0F), ConfigValues.BoolValues.DARK_TITANIUM_ARMOR);
	...
	public static final TmoArmorMaterial DARKANIUM = new TmoArmorMaterial(EnumHelper.addArmorMaterial("DARKANIUM", TMORefs.PREFIX+"darkanium", 36, new int[]{3, 6, 8, 3}, 10, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 2.5F), ConfigValues.BoolValues.DARKANIUM_ARMOR);
	public static final TmoArmorMaterial HALLOWED = new TmoArmorMaterial(EnumHelper.addArmorMaterial("HALLOWED", TMORefs.PREFIX+"hallowed", 36, new int[]{3, 6, 8, 3}, 10, SoundEvents.BLOCK_ENCHANTMENT_TABLE_USE, 2.5F), ConfigValues.BoolValues.HALLOWED_ARMOR);
